...
def is_locked_aria2_v4(contents: str) -> bool:
    ...
    if title_match is None:
        return False
    release_version = title_match.group(1)
    ...
    fixed_lines = {
        ...
        2: "",
        3: "- **Schema:** `aria2-record/v4`",
        4: f"- **Release version:** `{release_version}`",
        5: f"- **Upstream version:** `{upstream_version}`",
        8: (
            "- **Source origin:** [canonical upstream release archive]"
            f"({origin_url})"
        ),
        9: f"- **Source revision:** `release-{upstream_version}`",
        10: "- **License:** GPLv2; see `../GPLv2.txt`.",
        11: (
...
def status(component: str, contents: str) -> str:
    ...
    if component == "aria2" and is_locked_aria2_v4(contents):
